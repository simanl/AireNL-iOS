...
#import "StationsRequestResults.h"

@interface StationsRequestResults ()
...
@implementation StationsRequestResults
...
{
    NSNumber *stationID = measurement.stationID;
